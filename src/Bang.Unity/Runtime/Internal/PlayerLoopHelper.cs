...
internal static class PlayerLoopHelper {
    ...
    private static void RuntimeInit() {
        // Debug.Log( "PlayerLoopHelper::RuntimeInit()" );
    ...
    public static void Initialize(ref PlayerLoopSystem playerLoop)
    {
        ...
        InsertLoop(newLoop, typeof(PlayerLoopType.Initialization), typeof(BangLoopRunners.BangInitialization), static () => OnInitialization?.Invoke());
        InsertLoop(newLoop, typeof(PlayerLoopType.EarlyUpdate), typeof(BangLoopRunners.BangEarlyUpdate), static () => OnEarlyUpdate?.Invoke());
        InsertLoop(newLoop, typeof(PlayerLoopType.FixedUpdate), typeof(BangLoopRunners.BangFixedUpdate), static () => OnFixedUpdate?.Invoke());
        InsertLoop(newLoop, typeof(PlayerLoopType.PreUpdate), typeof(BangLoopRunners.BangPreUpdate), static () => OnPreUpdate?.Invoke());
        InsertLoop(newLoop, typeof(PlayerLoopType.Update), typeof(BangLoopRunners.BangUpdate), static () => OnUpdate?.Invoke());
        InsertLoop(newLoop, typeof(PlayerLoopType.PreLateUpdate), typeof(BangLoopRunners.BangPreLateUpdate), static () => OnPreLateUpdate?.Invoke());
        InsertLoop(newLoop, typeof(PlayerLoopType.PostLateUpdate), typeof(BangLoopRunners.BangPostLateUpdate), static () => OnPostLateUpdate?.Invoke());
        InsertLoop(newLoop, typeof(PlayerLoopType.TimeUpdate), typeof(BangLoopRunners.BangTimeUpdate), static () => OnTimeUpdate?.Invoke());
    ...
    private static void OnPlayModeStateChanged( UnityEditor.PlayModeStateChange playModeStateChange ) {
        if ( playModeStateChange is UnityEditor.PlayModeStateChange.ExitingPlayMode ) {
